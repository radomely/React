...
class Wrapper extends Component {
    ...
    removefromCart = (e) => {
        let title = e.target.dataset.name;
        let result = this.state.cart.filter(el => el.title !== title);
        this.setState({
            cart: result,
        })
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/* <Cart isCartShow = {isCartShow} toggleCart = {this.toggleCart} cart = {cart} removefromCart = {this.removefromCart}/>
                <PhoneList phones = {phones} addToCart = {this.addToCart}/> */}
                {/* {isCardShow ? <Cart toggleCart = {this.toggleCart}/> : null} */}
