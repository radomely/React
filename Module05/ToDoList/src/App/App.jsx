    ...
    render() {
        ...
        return (
            <div className="App">
                ...
                <Switch>
                <Route exact path='/' render={props => <Table taskList={whatToShow} deleteTask={this.deleteTask} editTask={this.editTask} doneTask={this.doneTask}/>}/>
                <Route path='/Done' render={props => <Table taskList={whatToShow} deleteTask={this.deleteTask} editTask={this.editTask} doneTask={this.doneTask}/>}/>
                <Route path='/Undone' render={props => <Table taskList={whatToShow} deleteTask={this.deleteTask} editTask={this.editTask} doneTask={this.doneTask}/>}/>
                </Switch>           
            </div>
        );
    }
